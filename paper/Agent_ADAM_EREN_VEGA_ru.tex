...
\title{Agent ADAM EREN VEGA: Концептуальная основа}
...
\begin{abstract}
Данная работа представляет Agent ADAM EREN VEGA как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
