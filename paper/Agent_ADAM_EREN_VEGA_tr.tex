...
\title{Agent ADAM EREN VEGA: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Agent ADAM EREN VEGA'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
