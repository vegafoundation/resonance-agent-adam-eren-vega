...
\title{Agent ADAM EREN VEGA: Un marco conceptual}
...
\begin{abstract}
Este trabajo introduce Agent ADAM EREN VEGA como un nuevo marco conceptual dentro del paradigma de Resonance Data y QIRC.
